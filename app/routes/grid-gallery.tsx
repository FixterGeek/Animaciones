...
const GridGallery = ({ images }: { images: string[] }) => {
  ...
  return (
    <article className="flex justify-center items-center h-screen bg-black">
          ...
          {isSelected ? (
            createPortal(
              <>
                <button
                  onClick={onClose}
                  className="absolute inset-0 flex justify-center items-center bg-black transition-all px-[5%]"
                >
                  <motion.img
                    role="button"
